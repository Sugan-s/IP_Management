...
<html lang="en">
  <head>
    ...
    <title>Subnet IP Address | IP</title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2>Subneted IP Addresses  |<a href="../service/assignServices.php"> Assign Service</a></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
						  ...
						  <td>
                                                      <a href="../user/assignUser.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                        ...
                        <tr>
                            <td><a href="../user/assignUser.php">67.78.56.24/24</a></td>
                            <td> </td>
                            <td> </td>
                            <td> </td>
                            <td> </td>
