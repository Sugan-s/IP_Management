...
$printDetails=new PrintDataTable();
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                        ...
                        {
                        ?>
                        <li><a id="addnewservice_1"  href="../serviceHandling/serviceDetails.php" ><i class="fa fa-gear"></i>Category Handling</a></li>
                        <li><a href="../userHandling/userHandling.php" ><i class="fa fa-user"></i>User Handling</a></li>
                        <li><a href="../mainBlock/mainblockDetails.php" ><i class="fa fa-info"></i>MainIp Block Handling</a></li>
                        <?php
                        }
                        ?>
                </ul>
